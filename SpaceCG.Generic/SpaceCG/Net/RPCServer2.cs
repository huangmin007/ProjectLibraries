...
namespace SpaceCG.Net
{
    ...
    /// XML-RPC 服务端
    /// </summary>
    public class RPCServer2 : IDisposable
    {
        /// <summary>
        /// Buffer Size
        /// </summary>
        ...
        public RPCServer2(IPAddress ipAddress, int localPort, string serverName)
        {
        ...
        /// <param name="localPort"></param>
        /// <param name="serverName"></param>
        public RPCServer2(int localPort, string serverName) : this(IPAddress.Any, localPort, serverName)
        {
        }        
        ...
        {
            if (string.IsNullOrWhiteSpace(objectName) || InvokeMessage2.NamedRegex.IsMatch(objectName) == false)
            ...
            if (objectType.IsValueType || objectType == typeof(RPCClient2))
        ...
        {
            if (_isDisposed)
                throw new ObjectDisposedException(nameof(RPCServer2));
        ...
        private async Task HandleClientReadAsync(TcpClient client, CancellationToken cancelToken)
        {
            ...
            try
            {
                while (!cancelToken.IsCancellationRequested && client.IsOnline())
                {
                    ...
                    var responseBytes = Encoding.UTF8.GetBytes(invokeResult.ToString());
        ...
        public bool TryCallMethod(XElement message, out InvokeResult invokeResult)
        {
            ...
            if (!InvokeMessage2.TryParse(message, out var invokeMessage, out var exceptionMessage))
            {
                invokeResult = new InvokeResult(InvokeStatusCode.Failed);
        ...
        /// <param name="invokeResult"></param>
        /// <returns></returns>
        public bool TryCallMethod(InvokeMessage2 invokeMessage, out InvokeResult invokeResult)
        {
            invokeResult = new InvokeResult(InvokeStatusCode.Failed);
        ...
        /// <param name="invokeResult"></param>
        /// <returns></returns>
        public bool TryCallMethod(string objectName, string methodName, out InvokeResult invokeResult) => TryCallMethod(new InvokeMessage2(objectName, methodName, null), out invokeResult);
        /// <summary>
        /// 试图调用指定实例对象的方法
        /// </summary>
        /// <param name="objectName"></param>
        ...
        /// <param name="invokeResult"></param>
        /// <returns></returns>
        public bool TryCallMethod(string objectName, string methodName, object[] parameters, out InvokeResult invokeResult) => TryCallMethod(new InvokeMessage2(objectName, methodName, parameters), out invokeResult);
        /// <summary>
        /// 试图调用指定实例对象的方法
        /// </summary>
        /// <param name="objectName"></param>
        ...
        /// <param name="invokeResult"></param>
        /// <returns></returns>
        public bool TryCallMethod(string objectName, string methodName, bool asynchronous, object[] parameters, out InvokeResult invokeResult) => TryCallMethod(new InvokeMessage2(objectName, methodName, asynchronous, parameters), out invokeResult);
        #endregion
        ...
        /// <param name="invokeMessage"></param>
        /// <returns>实例对象的方法调用成功，返回 <see cref="InvokeResult"/> 对象，否则返回 null 值 </returns>
        public InvokeResult CallMethod(InvokeMessage2 invokeMessage) => TryCallMethod(invokeMessage, out InvokeResult invokeResult) ? invokeResult : null;
        /// <summary>
        /// 调用实例对象的方法
        /// </summary>
        /// <param name="objectName"></param>
        /// <param name="methodName"></param>
        /// <returns>实例对象的方法调用成功，返回 <see cref="InvokeResult"/> 对象，否则返回 null 值 </returns>
        public InvokeResult CallMethod(string objectName, string methodName) => TryCallMethod(new InvokeMessage2(objectName, methodName), out InvokeResult invokeResult) ? invokeResult : null;
        /// <summary>
        /// 调用实例对象的方法
        /// </summary>
        /// <param name="objectName"></param>
        ...
        /// <param name="parameters"></param>
        /// <returns>实例对象的方法调用成功，返回 <see cref="InvokeResult"/> 对象，否则返回 null 值 </returns>
        public InvokeResult CallMethod(string objectName, string methodName, params object[] parameters) => TryCallMethod(new InvokeMessage2(objectName, methodName, parameters), out InvokeResult invokeResult) ? invokeResult : null;
        /// <summary>
        /// 调用实例对象的方法
        /// </summary>
        /// <param name="objectName"></param>
        ...
        /// <param name="asynchronous"></param>
        /// <returns>实例对象的方法调用成功，返回 <see cref="InvokeResult"/> 对象，否则返回 null 值 </returns>
        public InvokeResult CallMethod(string objectName, string methodName, bool asynchronous, params object[] parameters) => TryCallMethod(new InvokeMessage2(objectName, methodName, asynchronous, parameters), out InvokeResult invokeResult) ? invokeResult : null;
        #endregion
        ...
        /// <param name="invokeMessage"></param>
        /// <returns></returns>
        protected IEnumerable<MethodInfo> GetMethods(Type instanceType, InvokeMessage2 invokeMessage)
        {
