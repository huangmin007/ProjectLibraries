...
namespace LCMS_ModuleTemplate
{
    /// <summary>
    /// https://blog.csdn.net/qq_30585165/article/details/119191679
    ...
    public class UserActivityHook
    {
        ...
        private class KeyboardHookStruct
        {
            ...
            {
                return $"vkCode:{vkCode}, scanCode:{scanCode}, flags:{flags}, time:{time}, dwExtraInto:{dwExtraInfo}";
            }
        }
        #endregion
        ...
        public UserActivityHook(IntPtr pInstance)
        {
        ...
        /// </remarks>
        public UserActivityHook(IntPtr pInstance, bool InstallMouseHook, bool InstallKeyboardHook)
        {
            this.pInstance = pInstance;
        ...
        private IntPtr pInstance = IntPtr.Zero;
        ...
        public void Start(bool InstallMouseHook, bool InstallKeyboardHook)
        {
            ...
            if (hMouseHook == 0 && InstallMouseHook)
            {
                ...
                hMouseHook = SetWindowsHookEx(
                    WH_MOUSE_LL,
                    MouseHookProcedure,
                    pInstance == IntPtr.Zero ? Process.GetCurrentProcess().MainModule.BaseAddress : pInstance,
                    //pInstance == IntPtr.Zero ? Marshal.GetHINSTANCE(Assembly.GetExecutingAssembly().GetModules()[0]) : pInstance,
                    0);
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                if (KeyDown != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN))
                {
                    ...
                    //Console.WriteLine(MyKeyboardHookStruct);
