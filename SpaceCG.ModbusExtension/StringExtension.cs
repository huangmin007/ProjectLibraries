...
namespace SpaceCG.Generic
{
    public static partial class StringExtension
    {
        ...
        public static bool ToNumber<TNumber>(this String value, ref TNumber number, NumberStyles style = NumberStyles.None)
        ...
        /// <param name="style"></param>
        public static void ToNumberArray<TNumber>(this String value, ref TNumber[] defaultArray, char separator = ',', NumberStyles style = NumberStyles.None)
            where TNumber : struct, IComparable, IFormattable, IConvertible, IComparable<TNumber>, IEquatable<TNumber>
        {
        ...
        /// <param name="style"></param>
        /// <returns></returns>
        public static TNumber[] ToNumberArray<TNumber>(this String value, char separator = ',', NumberStyles style = NumberStyles.None)
            where TNumber : struct, IComparable, IFormattable, IConvertible, IComparable<TNumber>, IEquatable<TNumber>
        {
            string[] stringArray = value.Trim().Split(separator);

            TNumber[] array = new TNumber[stringArray.Length];

            ToNumberArray(value, ref array, separator, style);
        ...
        /// <returns></returns>
        public static void ToInt32Array(this String value, ref int[] array, char separator = ',', NumberStyles style = NumberStyles.None) => ToNumberArray<Int32>(value, ref array, separator, style);
        public static void ToUInt32Array(this String value, ref uint[] array, char separator = ',', NumberStyles style = NumberStyles.None) => ToNumberArray<UInt32>(value, ref array, separator, style);
        ...
        /// <param name="provider">一个对象，提供有关 string 的区域性特定格式设置信息。</param>
        /// <returns></returns>
        public static void ToByteArray(this String value, ref byte[] array, char separator = ',', NumberStyles style = NumberStyles.HexNumber) => ToNumberArray<Byte>(value, ref array, separator, style);
        /// <summary>
        ...
        /// <param name="style">枚举值的按位组合，用于指示可出现在 string 中的样式元素。要指定的一个典型值为 System.Globalization.NumberStyles.Integer。</param>
        /// <returns></returns>
        public static void ToUInt16Array(this String value, ref UInt16[] array, char separator = ',', NumberStyles style = NumberStyles.HexNumber) => ToNumberArray<UInt16>(value, ref array, separator, style);
